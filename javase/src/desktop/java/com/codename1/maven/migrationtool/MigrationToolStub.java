 ...
 * @author Shai Almog
 */
public class MigrationToolStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Migration Tool";
    private static final String APP_NAME = "MigrationTool";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MigrationToolStub());
    }
